...
public class Login extends javax.swing.JFrame {
    ...
    //Servicio de autenticación que contiene los usuarios y roles permitidos en el sistema. 
    ...
    private void initComponents() {
        ...
        btnIngresar.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
    ...
    /*
      Método que recoge las credenciales del formulario, valida el usuario y,
      si las credenciales son correctas, abre el menú principal con los
    ...
    private void realizarLogin() {
        ...
        Usuario u = loginService.validar(user, pass);
        if (u == null) {
